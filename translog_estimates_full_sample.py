# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 15:19:43 2024
...
# Load the data
production_data = pd.read_csv(r"C:\Users\bgiet\OneDrive\Documents\GitHub\ConflictingForces\ConflictingForces\sensitive_files\ConflictingForcesSensitive\production_data.csv", encoding='ISO-8859-2')

# Prepare the data
production_data['shifted_SDQ'] = production_data['SDQ_hyper_PCG_W2'] + 0.5
production_data['shifted_Conscientious'] = production_data['Conscientious_W2_PCG'] + 0.5
production_data['log_maths'] = np.log(production_data['Maths_points'])
production_data['log_english'] = np.log(production_data['English_points'])
production_data['log_cognition'] = np.log(production_data['cognition_pc'])
production_data['log_SDQ'] = np.log(production_data['shifted_SDQ'])
production_data['log_Conscientious'] = np.log(production_data['shifted_Conscientious'])
...
def model_function_tipi_maths(log_C, A, alpha, beta, gamma1, gamma2, gamma12):
    log_N = production_data['log_Conscientious']
    return translog_production_interaction(log_C, log_N, A, alpha, beta, gamma1, gamma2, gamma12)
...
log_C = production_data['log_cognition']
log_maths = production_data['log_maths']
log_english = production_data['log_english']
